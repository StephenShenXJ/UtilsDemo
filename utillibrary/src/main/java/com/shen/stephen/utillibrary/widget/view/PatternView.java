package com.shen.stephen.utillibrary.widget.view;
...
/**
 * A custom pattern lock view. For more details and usage please visit https://github.com/iChengc/PatternLockView
 */
public class PatternView extends View {
    ...
    private void init(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        mErrorColor = context.getResources().getColor(R.color.red);
        mPadding = getPaddingTop();
        mStrokeWidth = FileUtils.dip2px(context, 2f);
        ...
        mCellColor = typedArray.getColor(R.styleable.PatternView_cellColor, context.getResources().getColor(R.color.white));
        mSpacing = typedArray.getDimensionPixelOffset(R.styleable.PatternView_cellSpacing, FileUtils.dip2px(context, 32));
    ...
    public boolean onTouchEvent(MotionEvent event) {
        ...
        PLog.e("cell index:" + touchCellIndex + "  X:" + x + "   Y:" + y + "Center offset:" + mCenterOffset);
        if (touchCellIndex != -1) {
    ...
    private void finish() {
        ...
        if (mFinishListener != null && mTouchPoint != null) {
            if (!mFinishListener.onFinish(this, mSelectedCells, getStringPassword(mSelectedCells))) {
                mIsError = true;
                invalidate();
    ...
    private String getStringPassword(List<Integer> selectedCells) {
