...
import com.shen.stephen.utillibrary.widget.view.ClearableEditText;
...
public class SingleTextEditFragment extends PkiFragment {
     ...
     */
    public static final String TITLE_INTENT_KEY = "com.shen.stephen.utillibrary.widget.details.TITLE_INTENT_KEY";
    /**
     * The intent key for the edit content.
     */
    public static final String EDIT_CONTENT = "com.shen.stephen.utillibrary.widget.details.EDIT_CONTENT";
    public static final String MAX_LENGTH_LIMIT_KEY = "com.shen.stephen.utillibrary.widget.details.MAX_LENGTH_LIMIT_KEY";
    public static final String EDIT_CONTENT_TYPE_KEY = "com.shen.stephen.utillibrary.widget.details.EDIT_CONTENT_TYPE_KEY";
    public static final String IS_MULTILINE_KEY = "com.shen.stephen.utillibrary.widget.details.IS_MULTILINE_KEY";

    /**
     * The single text edit result key
     */
    public static final String SINGLE_TEXT_EDIT_RESULT_KEY = "com.shen.stephen.utillibrary.widget.details:SINGLE_TEXT_EDIT_RESULT_KEY";
