...
import com.shen.stephen.utillibrary.widget.view.GalleryImageView;
...
public class GalleryActivity extends PkiActivity implements View.OnClickListener {
    public static final String IMAGES_INTENT_KEY = "com.shen.stephen.utillibrary.widget.common.IMAGES_INTENT_KEY";
    public static final String IMAGES_INTENT_PATH = "com.shen.stephen.utillibrary.widget.common.IMAGES_INTENT_PATH";
    public static final String DEFAULT_INDEX_INTENT_KEY = "com.shen.stephen.utillibrary.widget.common.DEFAULT_INDEX_INTENT_KEY";
    public static final String DEFAULT_USERNAME = "com.shen.stephen.utillibrary.widget.common.DEFAULT_USERNAME";
