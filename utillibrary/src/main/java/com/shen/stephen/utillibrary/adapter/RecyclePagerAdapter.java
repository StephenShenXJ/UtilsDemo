package com.shen.stephen.utillibrary.adapter;
...
/**
 * RecyclePagerAdapter this is a {@link android.support.v4.view.ViewPager} adapter that extends {@link PagerAdapter}.
 * Use this adapter that can make sure that the page view can recycler used.
 */
